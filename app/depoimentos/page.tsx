...
export default function TestimonialsPage() {
  return <main>
    <header className="siteHeader">
      ...
      <nav aria-label="Navegação principal"><Link href="/">Início</Link><Link href="/#projetos">Projetos</Link><Link href="/#sobre">Sobre</Link><a href="mailto:rafaela.arantes.rj@gmail.com">Contato</a></nav>
    </header>
