...
export default function EducationPage(){return <main>
  <header className="siteHeader"><Link className="wordmark" href="/">Rafaela Arantes</Link><nav><Link href="/">Início</Link><Link href="/projetos">Projetos</Link><Link href="/depoimentos">Depoimentos</Link><a href="mailto:rafaaranteswork@gmail.com">Contato</a><Link className="languageSwitch" href="/en/education">EN</Link></nav></header>
