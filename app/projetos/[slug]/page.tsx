...
export default async function ProjectPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <main>
    <header className="siteHeader"><Link className="wordmark" href="/">Rafaela Arantes</Link><nav><Link href="/projetos">Todos os projetos</Link><Link href="/formacao">Formação</Link><Link href="/depoimentos">Depoimentos</Link><a href="mailto:rafaaranteswork@gmail.com">Contato</a><Link className="languageSwitch" href={`/en/projects/${slug}`}>EN</Link></nav></header>
